...
class WHTariffSerializer(serializers.Serializer):
    ...
    inbound_per_line = serializers.DecimalField(max_digits=12, decimal_places=4)

    outbound_per_order = serializers.DecimalField(max_digits=12, decimal_places=4)

    outbound_per_line = serializers.DecimalField(max_digits=12, decimal_places=4)
