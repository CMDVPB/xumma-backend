...
urlpatterns = [
     ...
     path("loads/<str:load_uf>/unload-to-warehouse/", SingleUnloadToWarehouseView.as_view(),
     ...
     path("loads/<str:load_uf>/reload-to-trip/", LoadReloadToTripView.as_view(), name="load-reload-to-trip"),
     path("loads/<str:load_uf>/arrive-to-warehouse/", LoadArriveToWarehouseView.as_view(), name="load-arrive-to-warehouse"),
