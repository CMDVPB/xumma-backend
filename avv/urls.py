...
urlpatterns = [
    ...
    path("part-attachments/upload/", PartAttachmentUploadView.as_view(),
         name="part-attachment-upload",
         ),
    path("part-files/<str:uf>/", PartFileProxyView.as_view(),
         name="part-file-proxy",
         ),
    path("part-attachments/<int:pk>/", PartAttachmentDeleteView.as_view(),
         name="part-attachment-delete",
         ),
    path("part-brands/", PartBrandListView.as_view()),
